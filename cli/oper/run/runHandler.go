...
// RunHandler runs a prompt with the given prompt-file and var-file paths.
//
// args: an array of 2 strings, the first being the path to the prompt file and
//       the second being the path to the var file.
// Returns nothing.
func RunHandler(args []string) {
	...
	promptPath, varPath := args[0], args[1]
